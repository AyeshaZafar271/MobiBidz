...
var pname = document.getElementById("product_name").textContent;
            ...
            case "succeeded":
                ...
                .then(data => {
                    if (data.payment_txn_id) {
                        window.location.href = 'payment-status.php?pid='+data.payment_txn_id+"&product_id"+pid+"&product_name="+pname+"&product_price="+price+"&cname="+customer_name+"&cemail="+customer_email;
                    } else {
