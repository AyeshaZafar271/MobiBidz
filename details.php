  ...
  <div id="main_content">
    ...
    <div class="column3">
      ...
      <div class="details_list">
        <ul>
          <li><span>Price:</span> <?php echo $product['price'] ?> $ </li>
          <li><span>Total In Stock:</span><label id="total_in_stock" name="total_in_stock"> <?php echo $product['total_in_stock'] ?> </label> </li>
